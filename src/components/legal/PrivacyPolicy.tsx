      ...
      <div className="container-bm" style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: 'var(--spacing-48)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: 'var(--spacing-16)' }}>
            <ShieldCheck size={20} style={{ color: 'var(--brand-cyan-hover)' }} />
        ...
        >
          ...
          <section>
            ...
            <ul style={{ paddingLeft: '24px', margin: 0, display: 'flex', flexDirection: 'column', gap: '8px' }}>
              ...
              <li style={{ fontFamily: 'var(--font-body)', fontSize: '15px', color: 'var(--grey-60)', lineHeight: 1.6 }}><strong>Financial Data</strong> is handled entirely by PayPal, our payment provider. Card and bank details are entered on PayPal\u2019s own pages, never on this site \u2014 we receive only confirmation that a payment succeeded, its amount and a PayPal reference, and we never see or store card numbers.</li>
