        ...
        >
          <section>
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '15px', color: 'var(--grey-60)', lineHeight: 1.6, marginBottom: '12px' }}>
              These terms and conditions outline the rules and regulations for the use of LeHart.co.uk's Website. By accessing this website we assume you accept these terms and conditions. Do not continue to use LeHart.co.uk if you do not agree to take all of the terms and conditions stated on this page.
            </p>
          </section>
          ...
          <section>
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '15px', color: 'var(--grey-60)', lineHeight: 1.6 }}>
              In no event shall LeHart.co.uk, nor any of its officers, directors and employees, be held liable for anything arising out of or in any way connected with your use of this Website whether such liability is under contract. LeHart.co.uk, including its officers, directors and employees shall not be held liable for any indirect, consequential or special liability arising out of or in any way related to your use of this Website.
            </p>
          </section>
